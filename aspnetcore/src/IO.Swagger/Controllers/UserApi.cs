...
{ 
    ...
    { 
        ...
        /// <response code="0">successful operation</response>
        [HttpPost]
        [Route("/Aleks-W/test/1.0.0/user/createWithArray")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpPost]
        [Route("/Aleks-W/test/1.0.0/user/createWithList")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/Aleks-W/test/1.0.0/user/{username}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/Aleks-W/test/1.0.0/user/login")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpGet]
        [Route("/Aleks-W/test/1.0.0/user/logout")]
        [ValidateModelState]
